...
import com.ofs.domain.inventory.client.StubInventoryClient;
import com.ofs.domain.payment.client.StubPaymentClient;
...
import com.ofs.domain.transaction.saga.SimpleSagaOrchestrator;
import com.ofs.domain.transaction.saga.SagaOrchestrator;
import com.ofs.domain.transaction.tcc.SimpleTccCoordinator;
import com.ofs.domain.transaction.tcc.TccCoordinator;
import com.ofs.app.transaction.seata.tcc.SeataTccCoordinator;
...
public class TransactionScenarioConfig {
    ...
    public OrderSubmitWithPaymentTccService orderSubmitWithPaymentTccService(
            com.ofs.domain.order.domain.service.OrderDomainService orderDomainService,
            @Qualifier("scenarioPaymentClient") com.ofs.domain.payment.client.PaymentClient paymentClient,
            @Qualifier("scenarioInventoryClient") com.ofs.domain.inventory.client.InventoryClient inventoryClient,
